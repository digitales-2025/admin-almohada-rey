                ...
                <div>
                  {expense.category ? (
                    <Badge
                      variant="outline"
                      className={
                        ExpenseCategoryLabels[expense.category as keyof typeof ExpenseCategoryLabels]?.className
                      }
                    >
                      {(() => {
                        const Icon =
                          ExpenseCategoryLabels[expense.category as keyof typeof ExpenseCategoryLabels]?.icon;
                ...
                <div>
                  {expense.documentType ? (
                    <Badge
                      variant="outline"
                      className={
                        ExpenseDocumentTypeLabels[expense.documentType as keyof typeof ExpenseDocumentTypeLabels]
                          ?.className
                      }
                    >
                      {(() => {
