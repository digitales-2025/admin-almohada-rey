...
import { getMethodColor, getMethodIcon } from "@/app/(admin)/reservation/_utils/reservationPayment.utils";
import { FormField, FormItem, FormLabel, FormMessage } from "@/components/ui/form";
import { cn } from "@/lib/utils";

interface StepPaymentDetailRoomMethodProps {
  form: UseFormReturn<CreateRoomPaymentDetailSchema>;
}

export default function StepPaymentDetailRoomMethod({ form }: StepPaymentDetailRoomMethodProps) {
  return (
    <FormField
