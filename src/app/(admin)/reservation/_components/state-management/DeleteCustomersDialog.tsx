...
// interface DeleteCustomersDialogProps extends ComponentPropsWithoutRef<typeof AlertDialog> {
...
//   const { onTransitionReservationStatus } = useReservation();

//   const onDeleteCustomersHandler = () => {
//     onDeleteCustomers(customers);
...
//             <AlertDialogDescription>
//               Esta acción eliminará a<span className="font-medium"> {customers.length}</span>
...
//               onClick={onDeleteCustomersHandler}
...
//           <Button aria-label="Delete selected rows" onClick={onDeleteCustomersHandler} disabled={isDeletePending}>
//             {isDeletePending && <RefreshCcw className="mr-2 size-4 animate-spin" aria-hidden="true" />}
//             Eliminar
//           </Button>
//           <DrawerClose asChild>
