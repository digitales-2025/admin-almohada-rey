    ...
    <SidebarGroup>
      ...
      <SidebarMenu>
        {items.map((item) => {
          ...
          if (!item.items) return <SidebarMenuLink key={key} item={item} href={currentPath} />;

          if (state === "collapsed") return <SidebarMenuCollapsedDropdown key={key} item={item} href={currentPath} />;
