...
>(({ className, sizeInput = "md", ...props }, ref) => (
  <div
    className={cn(
      ...
      sizeInput === "sm" && "h-8 text-sm",
      sizeInput === "md" && "h-10 text-sm",
      sizeInput === "lg" && "h-12 text-sm"
    )}
    cmdk-input-wrapper=""
  >
    <MagnifyingGlassIcon className="h-4 w-4 mr-2 shrink-0 opacity-50" />
    <CommandPrimitive.Input
      ...
      className={cn(
        ...
        sizeInput === "sm" && "h-8 py-1 text-sm",
        sizeInput === "md" && "h-10 py-2 text-sm",
        sizeInput === "lg" && "h-12 py-3 text-sm",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.List ref={ref} className={cn("max-h-[10rem]", className)} {...props} />
));
